...
export function Onboarding({ controller, initial, onClose }: { controller: TerminalController; initial: Session; onClose: () => void }) {
  ...
  return <Menu title="Choose your models · 3 of 3" search={false} onClose={() => setStep(1)} footer={state.notice || 'Saved for this workspace in both clients. /models has advanced options.'} items={[
