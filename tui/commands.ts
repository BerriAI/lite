...
export const COMMAND_ORDER = ['models', 'sessions', 'new', 'mode', 'settings', 'setup', 'permissions', 'changes', 'work', 'timeline', 'copy', 'workers', 'todos', 'goal', 'queue', 'steer', 'stop', 'files', 'attach', 'attachments', 'editor', 'shell', 'commands', 'drafts', 'history', 'undo', 'redo', 'recover', 'fork', 'compact', 'rename', 'archive', 'export', 'import', 'theme', 'thinking', 'actions', 'timestamps', 'outputs', 'animations', 'refresh', 'notice', 'delete', 'quit'];
