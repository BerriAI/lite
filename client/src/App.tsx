...
export default function App() {
  ...
  return <div className={`app ${sidebarOpen ? 'sidebar-is-open' : ''}`}>
    ...
    {setup && settings && <Onboarding key={`${setup.id}:${setup.workspace}`} selection={setup.selection} settings={settings} onSave={saveSetup} onClose={() => setSetup(null)} renderProviders={close => <Settings settings={settings} onClose={close} onSave={saveSettings} />} />}
