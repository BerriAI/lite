...
export interface SessionGoal {
  ...
  turns: number;
  /** Continuation ceiling (default 10, hard cap 25); reaching it blocks the goal. */
  maxTurns: number;
...
export const GOAL_LIMITS = { textChars: 2000, noteChars: 1000, defaultMaxTurns: 10, maxTurnsCap: 25 } as const;
