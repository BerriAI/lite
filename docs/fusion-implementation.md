...
- The Fusion family budget is eight invocations and 30 cumulative active minutes. Individual workers have no model-step ceiling, 10 active minutes, a 16 MiB transcript bound, and a 64 KiB report bound. Approval waits do not consume active worker time.
