...
export function generateSystem(colors: TerminalColors, mode: ThemeMode): Theme {
  ...
  const theme: Record<ThemeToken, RGBA> = {
    ...
    markdownText: fg, markdownHeading: magenta, markdownLink: blue, markdownLinkText: cyan,
    markdownCode: green, markdownBlockQuote: yellow, markdownEmph: yellow, markdownStrong: yellow,
    markdownHorizontalRule: generateMutedText(bg, mode), markdownListItem: cyan,
    markdownListEnumeration: cyan, markdownImage: blue, markdownImageText: cyan, markdownCodeBlock: fg,
